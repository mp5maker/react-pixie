  ...
  const memoHighlightButton = React.useMemo(() => {
    return (
      <div>
        {theme == LIGHT && (
          <img
            src="/Showcase/highlight-button-light.png"
            alt={`highlight-button-light`}
          />
        )}
        {theme == DARK && (
          <img
            src="/Showcase/highlight-button-dark.png"
            alt={`highlight-button-dark`}
          />
        )}
      </div>
    );
  ...
  return (
    <div
      ...
      <Drawer
        ...
        buttonDisplay={<FontAwesomeIcon icon={faPencilRuler} />}>
        {({ toggleDrawer }: any) => {
          return (
            <React.Fragment>
              <div className="grid">
