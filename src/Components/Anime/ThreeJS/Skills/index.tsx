...
export const Skills = ({ colors }: any) => {
    ...
    React.useEffect(() => {
        ...
        loader.load('/Skills/react.svg', (data) => reactGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/slack.svg', (data) => slackGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/github.svg', (data) => githubGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/webpack.svg', (data) => webpackGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/npm.svg', (data) => npmGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/sass.svg', (data) => sassGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/angular.svg', (data) => angularGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/trello.svg', (data) => angularGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/django.svg', (data) => djangoGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/bootstrap.svg', (data) => bootstrapGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/jquery.svg', (data) => jqueryGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/python.svg', (data) => pythonGroup = onSuccessLoad({
            data,
        ...
        loader.load('/Skills/php.svg', (data) => phpGroup = onSuccessLoad({
            data,
            position: { x: 150, y: -20, z: -300 },
            scale: { x: 0.5, y: 0.5, z: 0.5 },
            rotation: { x: -Math.PI, y: 0, z: 0 }
