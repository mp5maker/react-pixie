    ...
    return (
      <>
        <sphereBufferGeometry
          ...
          ref={sphereRef}
          attach={`geometry`}
          args={[frequencyParam * 12, frequencyParam * 25, frequencyParam * 25]}
        />
        {sphereGeometry && (
          <group>
            <pointLight position={[200, 100, -100]} ref={pointLightRef} />
            <lineSegments
              ref={lineRef}
        ...
        <group position={[200, 120, -100]} ref={bulbRef}>
          <mesh castShadow={true} receiveShadow={true}>
            ...
            <pointLight args={[colors.primaryColor, 2, 800]} />
          </mesh>
          <mesh ref={bulbOuterRef}>
            <meshLambertMaterial
              attach={`material`}
              side={THREE.DoubleSide}
              color={colors.primaryColor}
            />
            <circleGeometry attach={`geometry`} args={[5, 20]} />
          </mesh>
        </group>
      </>
    );
