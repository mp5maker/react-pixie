...
export const Bird = ({ colors }: any) => {
  ...
  React.useEffect(() => {
    loader.load('/AnimationModel/Flamingo.glb', gltf =>
      onSuccessLoad({ gltf, name: `flamingo` }),
    );
    loader.load('/AnimationModel/Parrot.glb', gltf =>
      onSuccessLoad({ gltf, name: `parrot` }),
    );
  }, []);
